...
ui <- fluidPage(
  ...
  css(
    ".btn.dropdown-toggle {/* color del picker mismo */
      color:",
    color_texto,
    ";
      background-color:",
  ...
  fluidRow(
    column(
      ...
      div(
        markdown(
          "[Bastián Olea Herrera](https://bastianolea.github.io/shiny_apps/)"
        ),
      ...
      div(
        style = "font-size: 130%;",
        p(
          "Tablero que reúne los principales indicadores para comprender la situación económica del país."
        ),

        p(markdown(
          "Todos los datos son obtenidos directamente desde la base de datos estadísticos del [Banco Central](https://si3.bcentral.cl/siete). Los datos se actualizan automáticamente dos veces al día."
        ))
      ),
      ...
      div(
        ...
        div(
          style = paste(
            "display: inline-block; font-size: 90%; opacity: .4; color:",
            color_destacado,
            ";"
          ),
          ...
          p(
            ...
            em(
              style = "font-size: 90%;",
              textOutput("ultima_actualizacion", inline = T)
            )
          ),
          ...
          p(
            ...
            em(
              style = "font-size: 90%;",
              textOutput("dato_mas_reciente", inline = T)
            )
          ),
        )
      )
  ...
  fluidRow(
    ...
    column(
      12,
      style = "margin-bottom: -25px; font-size: 130%;",
      div(style = "display: inline-block;", p("Durante los últimos")),
      div(
        style = "display: inline-block;",
        pickerInput(
          "fecha_corte",
          label = NULL,
          choices = c("3 meses", "6 meses", "12 meses", "24 meses"),
          selected = "6 meses",
          width = 110
        )
      ),
    ...
    column(
      ...
      uiOutput("tendencias_ui") |>
        withSpinner(color = color_secundario, proxy.height = 400)
    )
  ),
  ...
  fluidRow(
    div(
      style = "padding: 30px; max-width: 900px; margin: auto;", # ancho fijo
      ...
      fila_indicador(
        ...
        panel_grafico_variacion("Variación trimestral del PIB", "pib_g_var"),

        panel_grafico_historico("Evolución del PIB", "pib_g_hist")
      ),

      ## imacec ----
      fila_indicador(
        panel_titular(
          titulo = "Indicador Mensual de Actividad Económica (Imacec)",
        ...
        panel_grafico_variacion("Variación mensual del Imacec", "imacec_g_var"),

        panel_grafico_historico("Evolución del Imacec", "imacec_g_hist")
      ),

      ## ipsa ----
      fila_indicador(
        panel_titular(
          titulo = "Índice de Precios Selectivo de Acciones (IPSA)",
        ...
        panel_grafico_variacion("Variación mensual del IPSA", "ipsa_g_var"),

        panel_grafico_historico("Evolución del IPSA", "ipsa_g_hist")
      ),

      ## inversión extranjera ----
      fila_indicador(
        panel_titular(
          titulo = "Inversión Extranjera Directa (IED)*",
        ...
        panel_grafico_variacion(
          "Variación mensual de la Inversión Extranjera",
          "invext_g_var"
        ),

        panel_grafico_historico(
      ...
      fila_indicador(
        ...
        panel_grafico_variacion("Variación mensual del IPC", "ipc_g_var"),

        panel_grafico_historico("Evolución del IPC", "ipc_g_hist")
      ),
      ...
      fila_indicador(
        ...
        panel_grafico_variacion("Variación mensual de la UF", "uf_g_var"),

        panel_grafico_historico("Evolución de la UF", "uf_g_hist")
      ),
      ...
      fila_indicador(
        ...
        panel_grafico_variacion(
          "Variación mensual de la tasa de desempleo",
          "desempleo_g_var"
        ),
      ...
      fila_indicador(
        panel_titular(
          titulo = "Índice real de remuneraciones",
        ...
        panel_grafico_variacion(
          "Variación mensual de las remuneraciones reales",
      ...
      fila_indicador(
        ...
        panel_grafico_variacion(
          "Variación mensual del precio del cobre",
          "cobre_g_var"
        ),
      ...
      fila_indicador(
        ...
        panel_grafico_variacion(
          "Variación mensual del índice de producción industrial",
  ...
  fluidRow(
    column(
      12,
      p(
        "*: Inversión Extranjera Directa expresada como media móvil de los últimos 3 meses, debido a la volatilidad del indicador."
      )
    )
  ),
  ...
  fluidRow(
    column(
      12,
      style = "opacity: 1; font-size: 90%; margin-top: 0;",

      markdown(
        "Desarrollado y programado por [Bastián Olea Herrera,](https://bastian.olea.biz) usando el lenguaje de programación estadístico R."
      ),
      ...
      markdown(
        "Datos, código de fuente de esta app, y código del procesamiento de los datos [disponible en el repositorio de GitHub.](https://github.com/bastianolea/economia_chile)"
      ),
...
server <- function(input, output) {
  ## cargar datos ----
  localmente = FALSE #cargar datos locales desde el inicio del proyecto, o desde la carpeta app (dejar en false si se corre la app, true para debugear fuera de la app)
  ...
  ## tendencias texto ----
  output$pib_tendencia <- renderUI(tendencia_ui(
    datos_pib,
    fecha_corte(),
    input,
    subir = "bueno"
  ))
  output$imacec_tendencia <- renderUI(tendencia_ui(
    datos_imacec,
    fecha_corte(),
    input,
    subir = "bueno"
  ))
  output$ipc_tendencia <- renderUI(tendencia_ui(
    datos_ipc,
    fecha_corte(),
    input,
    subir = "malo"
  ))
  output$uf_tendencia <- renderUI(tendencia_ui(
    datos_uf,
    fecha_corte(),
    input,
    subir = "malo"
  ))
  output$ipsa_tendencia <- renderUI(tendencia_ui(
    datos_ipsa,
    fecha_corte(),
    input,
    subir = "bueno"
  ))
  output$desempleo_tendencia <- renderUI(tendencia_ui(
    datos_desempleo,
    fecha_corte(),
    input,
    subir = "malo"
  ))
  output$remuneraciones_tendencia <- renderUI(tendencia_ui(
  ...
  # nuevas
  output$invext_tendencia <- renderUI(tendencia_ui(
    datos_invext,
    fecha_corte(),
    input,
    subir = "bueno"
  ...
  output$prod_industrial_tendencia <- renderUI(tendencia_ui(
    datos_prod_industrial,
    fecha_corte(),
    input,
    subir = "bueno"
  ))

  output$pib_tendencia_texto <- renderText(tendencia_texto(
    datos_pib,
    fecha_corte(),
    input
  ))
  output$imacec_tendencia_texto <- renderText(tendencia_texto(
    datos_imacec,
    fecha_corte(),
    input
  ))
  output$ipc_tendencia_texto <- renderText(tendencia_texto(
    datos_ipc,
    fecha_corte(),
    input
  ))
  output$uf_tendencia_texto <- renderText(tendencia_texto(
    datos_uf,
    fecha_corte(),
    input
  ))
  output$ipsa_tendencia_texto <- renderText(tendencia_texto(
    datos_ipsa,
    fecha_corte(),
    input
  ))
  output$desempleo_tendencia_texto <- renderText(tendencia_texto(
    datos_desempleo,
    fecha_corte(),
    input
  ))
  output$remuneraciones_tendencia_texto <- renderText(tendencia_texto(
    datos_remuneraciones,
    fecha_corte(),
    input
  ))
  ...
  #nuevas
  output$invext_tendencia_texto <- renderText(tendencia_texto(
    datos_invext,
    fecha_corte(),
    input
  ))
  output$cobre_tendencia_texto <- renderText(tendencia_texto(
    datos_cobre,
    fecha_corte(),
    input
  ))
  ...
  output$tendencias_ui <- renderUI({
    div(
      panel_tendencia("El PIB", "pib_tendencia", "pib_tendencia_texto"),
      ...
      panel_tendencia(
        ...
        "invext_tendencia",
        "invext_tendencia_texto"
      ), #nueva

      panel_tendencia("El IPSA", "ipsa_tendencia", "ipsa_tendencia_texto"),

      panel_tendencia("El IPC", "ipc_tendencia", "ipc_tendencia_texto"),
      ...
      panel_tendencia(
        "El valor de las remuneraciones",
      ...
      panel_tendencia(
        "El precio del cobre",
        "cobre_tendencia",
        "cobre_tendencia_texto"
      ), #nueva

      panel_tendencia(
        "La producción industrial",
        "prod_industrial_tendencia",
        "prod_industrial_tendencia_texto"
      ) #nueva nueva
    )
  })
  ...
  output$imacec_ui <- renderUI(dato_ui(
    datos_imacec,
    unidad = "índice 100",
    año_base = 2018
  ))
  output$ipc_ui <- renderUI(dato_ui(
    datos_ipc,
    unidad = "índice 100",
    año_base = 2023,
    subir = "malo"
  ...
  output$ipsa_ui <- renderUI(dato_ui(
    datos_ipsa,
    unidad = "índice 1000",
    año_base = 2003
  ))
  output$desempleo_ui <- renderUI(dato_ui(
    datos_desempleo,
    unidad = "porciento",
    año_base = "% fuerza de trabajo",
    subir = "malo"
  ))
  output$remuneraciones_ui <- renderUI(dato_ui(
    datos_remuneraciones,
    unidad = "índice 100",
    año_base = 2023
  ))
  ...
  # nuevos
  output$invext_ui <- renderUI(dato_ui(
    datos_invext,
    unidad = "millones de dólares"
  ))
  output$cobre_ui <- renderUI(dato_ui(
    datos_cobre,
    unidad = "dólares por libra",
    diario = TRUE
  ))

  # nuevos nuevos
  output$prod_industrial_ui <- renderUI(dato_ui(
    datos_prod_industrial,
    unidad = "índice 100",
    año_base = 2018
  ))
  ...
  ## gráficos variación ----
  output$pib_g_var <- renderPlot(grafico_variacion(
    datos_pib,
    escala = "trimestre"
  ))
  ...
  output$desempleo_g_var <- renderPlot(grafico_variacion(
    datos_desempleo,
    subir = "malo"
  ))
  output$remuneraciones_g_var <- renderPlot(grafico_variacion(
    datos_remuneraciones
  ))

  # nuevos
  output$invext_g_var <- renderPlot(grafico_variacion(datos_invext))
  output$cobre_g_var <- renderPlot(grafico_variacion(
    datos_cobre,
    mensualizar = TRUE
  ))

  # nuevos nuevos
  output$prod_industrial_g_var <- renderPlot(grafico_variacion(
    datos_prod_industrial
  ))

  ## gráficos históricos ----
  output$pib_g_hist <- renderPlot(grafico_historico(
    datos_pib,
    escala = "trimestre"
  ))
  ...
  output$remuneraciones_g_hist <- renderPlot(grafico_historico(
    datos_remuneraciones
  ))
  ...
  # nuevos nuevos
  output$prod_industrial_g_hist <- renderPlot(grafico_historico(
    datos_prod_industrial
  ))
}
